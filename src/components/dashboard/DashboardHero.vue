  ...
  <section class="mx-auto mb-5 flex w-full max-w-[1180px] flex-col gap-5 lg:flex-row lg:items-start lg:justify-between">
    ...
    <div class="flex flex-wrap gap-3">
      <button
        ...
        :key="action.label"
        :class="[
          'inline-flex h-11 cursor-pointer items-center gap-2 rounded-2xl border px-4 text-[13px] font-semibold transition hover:shadow-[0_10px_24px_rgba(112,136,181,0.1)]',
